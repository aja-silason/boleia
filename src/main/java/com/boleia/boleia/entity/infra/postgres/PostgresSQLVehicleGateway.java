...
public class PostgresSQLVehicleGateway implements VehicleGateway {
    ...
    private VehicleOutput toOutput(VehicleModel model) {    
        return new VehicleOutput(model.getId(), model.getPlate(), model.getModel(), model.getColor(), model.getBrand(), model.getYear(), model.getSeats(), model.getStatus(), model.getCreatedAt().toString(), model.getUpdatedAt().toString());
    }
